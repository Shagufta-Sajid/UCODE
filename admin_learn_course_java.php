...
<div class="row">
  ...
  <font color= "#643B70"><h1>Upload New Materials Here:</h1>

  <form action="admin_learn_course_java1.php" method="post" enctype="multipart/form-data">

    <label for="ft"><b>File Title:</b></label>
    <input type="text"  name="ft" required><br><br><br>

    <input type="file"  name ="upload" required>
    (*zip long files/videos before upload)<br><br><br>
  ...
  <font color= "#643B70"><h1>Click Here For See All Uploaded Materials And Details:</h1>
<form action="admin_learn_course_java2.php" method="post">
        
    <button type="submit">See All Materials</button>
