...
<form action="admin_learn_course_java.php" method="post">
...
<br><font color= "#643B70"><h1>Delete File Here:</h1>
  <form action="admin_learn_course_java3.php" method="post">
  
  <label for="fno"></label>
    <input type="number"  name="fno" placeholder="File No." required>
...
if($query)
{
...

    {
...

       {
          ...
          echo'<td><p><a href="learnCourse_java/'.$row["filename"].'" >'.$row["filename"].'</a></p></td>';
