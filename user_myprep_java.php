...
<div class="content">
  ...
  <a href="user_myprep_java_mark.php" ><h2>See Previous Attempt Result<h2></a>


<form action="user_myprep_java1.php" method="post">   
    <h1>Attempt For The Quiz!<h1>
    <h3>*(Submit Before Time Out)<h3>

  <button type="submit">Attempt Now</button>
</form>
