...
if(isset($_POST['submit'])){
    ...
    if(in_array($file_extension,$extension)){
        ...
        $upload_image='notices/'.$imagefilename;
        ...
        if($result){
          header("Location:admin_notice2.php");
...
<div id="navbar">
  ...
  <a href="user_notice.php"><b>Notice</b></a>
...
<table class="table table-bordered w-70 h-50">
  ...
  <tbody>
    ...
    $sql= "SELECT notice_id,notices,notice_date,image FROM notice ORDER BY notice_id DESC";
    $result=mysqli_query($con,$sql);
    $id=1;
